...
func (prefixType) CompileOptions() []cel.EnvOption {
	return []cel.EnvOption{
		cel.Declarations(
			decls.NewFunction("custom.AddPrefix",
				decls.NewOverload("add_prefix",
...
func (prefixType) ProgramOptions() []cel.ProgramOption {
	return []cel.ProgramOption{
		cel.Functions(
			&functions.Overload{
				Operator: "custom.AddPrefix",
				Binary:   callInStringStringOutString(addPrefixImpl),
			},
		),
	}
}
